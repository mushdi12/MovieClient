...
import static frontend.MainController.*;
...
public class UpdateController {
    ...
    void initialize() {
        ...
        for (Movie m_ : list) {
            if (m_.getId() == index_for_update){
                update_movie = m_;
            }
        }
        movie_name.setText(update_movie.getName());
        m_x.setText(String.valueOf(update_movie.coordinate.getX()));
        m_y.setText(String.valueOf(update_movie.coordinate.getY()));
        oscar.setText(String.valueOf(update_movie.getOscarsCount()));
        genre_combo.setValue(update_movie.getGenre());
        mpa_combo.setValue(update_movie.getMpaaRating());
        d_name.setText(update_movie.director.getName());
        year.setText(String.valueOf(update_movie.director.birthday.getYear()));
        month.setText(String.valueOf(update_movie.director.birthday.getMonthValue()));
        day.setText(String.valueOf(update_movie.director.birthday.getDayOfMonth()));
        hour.setText(String.valueOf(update_movie.director.birthday.getHour()));
        minute.setText(String.valueOf(update_movie.director.birthday.getMinute()));
        second.setText(String.valueOf(update_movie.director.birthday.getSecond()));
        eye.setValue(update_movie.director.getEyeColor());
        hair.setValue(update_movie.director.getHairColor());
        nationality.setValue(update_movie.director.getNationality());
        d_x.setText(String.valueOf(update_movie.director.location.getX()));
        d_y.setText(String.valueOf(update_movie.director.location.getY()));
        d_z.setText(String.valueOf(update_movie.director.location.getZ()));
    ...
    void finish() throws IOException, ClassNotFoundException {
        ...
        Movie m = new Movie(index_for_update, name_movie, coordinates_movie, ZonedDateTime.now(), oscar_movie, genre_combo.getValue(), mpa_combo.getValue(), person, this_client);
        send(channel, new Shipment("update", m, 5, this_client));
