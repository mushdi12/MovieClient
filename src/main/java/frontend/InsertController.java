...
import static frontend.MainController.index_for_insert;
...
public class InsertController {
    ...
    void finish() throws IOException, ClassNotFoundException {
        ...
        Movie m = new Movie(index_for_insert, name_movie, coordinates_movie, ZonedDateTime.now(), oscar_movie, genre_combo.getValue(), mpa_combo.getValue(), person, this_client);
        send(channel, new Shipment("insert_at", m, 5, this_client));
